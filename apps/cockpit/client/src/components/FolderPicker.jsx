...
export function FolderPicker({ onSelect, onClose, recentCwds = [] }) {
  ...
  return (
    <Dialog
      ...
      className="bg-gray-900 border border-gray-700 rounded-lg max-w-lg w-[calc(100%-2rem)] flex flex-col max-h-[80vh]"
    >
      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-700">
        <h2 id="folder-picker-title" className="text-sm font-semibold text-gray-200">
