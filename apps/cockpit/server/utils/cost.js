...
// 2026-06 (Haiku 4.5, Sonnet 4.6, Opus 4.5+, Fable/Mythos 5). Cache rates are
// the standard 1.25x input (5-min write) and 0.1x input (read). Family-level
// granularity: all versions of a family share one entry, priced at the current
// generation — budget enforcement (Fleet) and usage analytics both read this.
