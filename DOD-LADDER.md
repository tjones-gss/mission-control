...
| Criterion | Proven by | Closes |
|---|---|---|
| Cross-vendor oversight: real Cursor reader in one view — or label honestly dropped | multi-vendor session contract test, or ADR-0005 label correction | absorption premortem "cross-vendor never built" |
